...
import Recharge_Operate_Analysis.Utils.OrderTop10Helper
...
object OrderTop10 {
  def main(args: Array[String]): Unit = {
    ...
    val res: DataSet[(String, Int, Double)] = redueced
      .map(line => {
        (line._1, line._2, line._3 * 1.0/ line._2 )
      }).sortPartition(1,Order.DESCENDING)
        .first(10)

    res.map(x => {
      OrderTop10Helper.invokeTopN(x._1,x._2,x._3)
      OrderTop10Helper.close()
    })
