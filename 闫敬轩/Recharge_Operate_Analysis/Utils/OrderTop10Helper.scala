...
/**
  ...
  * @version 1.0
  */
object OrderTop10Helper extends RichSinkFunction[Tuple3[String,Int,Double]] with Serializable {
  ...
  /**
   ...
   def invokeTopN(value: (String, Int,Double)): Unit = {
      val sql = "insert into OrderTop10(provinceName,cnt,rate) values(?,?,?)"
